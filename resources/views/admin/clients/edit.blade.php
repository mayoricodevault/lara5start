                                ...
                                <div class="cd-block">
                                    <div class="cd-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input id="activate" name="activate" type="checkbox" class="pos-rel p-l-30" value="1" @if($user->isActivated()) checked="checked" @endif {{ ($user->id === Sentry::getId() ? ' disabled="disabled"' : '') }} />
                                            </div>
                                        </div>
